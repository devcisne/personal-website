    ...
    <>
      <div className="flex flex-col mb-2">
        ...
        <p className=" flex flex-row space-x-2 mx-auto">
          <a href="https://github.com/devcisne" className="text-gray-500 hover:text-gray-900"><BsGithub /></a>
          <a href="https://twitter.com/devcisne" className="text-gray-500 hover:text-gray-900"><BsTwitter /></a>
